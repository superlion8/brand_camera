#!/usr/bin/env node
/**
 * 上传 V4-tags/models 文件夹到 Supabase Storage presets/all_models
 */
...
async function main() {
  console.log('🚀 上传 V4-tags/models 到 Supabase Storage...')
  ...
  for (const file of files) {
    ...
    // 保持原文件名
    const remotePath = `${TARGET_FOLDER}/${file.toLowerCase()}`
