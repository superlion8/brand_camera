export const zh = {
  ...
  proStudio: {
    ...
    modeLabel: "模式",
    proStudioMode: "专业棚拍模式",
    proStudioModeDesc: "上传商品图片后，AI 将为你生成 4 张不同风格的专业模特展示图",
    ...
    maxItems: "最多{count}件",
    maxItemsWarning: "最多4件商品，过多可能影响生成质量",
    add: "添加",
    addMoreTip: "💡 添加更多商品可生成穿搭组合效果",
    smartModelMatch: "智能模特匹配",
    smartModelMatchDesc: "根据商品自动匹配最合适的模特",
    proBgScene: "专业背景场景",
    proBgSceneDesc: "多种专业摄影背景可选",
    highQualityOutput: "高质量输出",
  ...
  brandStyle: {
    ...
    // 输入页面
    productPageUrl: "商品详情页链接",
    productPageUrlDesc: "最能体现您品牌风格的官网商品页",
    productPagePlaceholder: "https://www.example.com/product/...",
    instagramUrl: "Instagram 内容链接",
    instagramUrlDesc: "最能体现您品牌风格的 INS 帖子",
    instagramPlaceholder: "https://www.instagram.com/p/...",
    videoUrl: "UGC 短视频链接",
    videoUrlDesc: "一条讲解商品的短视频 (TikTok/YouTube/IG Reels)",
    videoPlaceholder: "https://www.tiktok.com/@user/video/...",
    productImage: "商品图片",
    productImageDesc: "用于模特拍摄的商品图",
    uploadProductImage: "点击上传商品图",
    startAnalysis: "开始分析",
    submitting: "正在提交...",
    
    // 分析页面
    analyzing: "正在分析",
    analyzeProductPage: "分析商品页",
    analyzeProductPageDesc: "读取页面内容，提取品牌模特图和商品图",
    analyzeInstagram: "分析 Instagram",
    analyzeInstagramDesc: "提取帖子图片，选择最佳模特展示图",
    analyzeVideo: "分析短视频",
    analyzeVideoDesc: "理解视频内容，提取风格要素",
    generateSummary: "生成品牌摘要",
    generateSummaryDesc: "整合分析结果，生成品牌风格关键词",
    analysisComplete: "分析完成",
    continueToConfirm: "继续确认",
    stepCompleted: "已完成",
    stepFailed: "分析失败",
    
    // 确认页面
    confirmTitle: "确认分析结果",
    confirmDesc: "请确认以下分析结果，如有误可点击更换",
    webModelRef: "官网模特参考",
    webModelRefDesc: "用于生成官网展示图",
    insModelRef: "INS 模特参考",
    insModelRefDesc: "用于生成 INS 风格图",
    productRef: "商品图参考",
    productRefDesc: "用于生成纯商品展示图",
    videoPrompt: "视频提示词",
    videoPromptDesc: "用于生成 UGC 风格短视频",
    brandSummary: "品牌摘要",
    brandSummaryDesc: "品牌定位与风格关键词",
    keywords: "关键词",
    change: "更换",
    addKeyword: "添加",
    inputKeyword: "输入关键词",
    ...
    productImageCount: "1 张商品展示图",
    ugcVideoCount: "1 条 UGC 风格短视频",
    brandStyleSummary: "品牌风格摘要",
    selectRefImage: "选择参考图",
    selectWebModel: "选择官网模特参考图",
    selectInsModel: "选择 INS 模特参考图",
    selectProductRef: "选择商品参考图",
    editVideoPrompt: "编辑视频提示词",
    editBrandSummary: "编辑品牌风格摘要",
    videoPromptPlaceholder: "描述视频风格...",
    brandSummaryPlaceholder: "描述品牌风格...",
    save: "保存",
    cancel: "取消",
    uploadNewImage: "上传新图片",
    selectFromResults: "或从分析结果中选择：",
    noImagesAvailable: "暂无可选图片，请上传新图片",
    styleKeywords: "风格关键词",
    ...
    insStyleImageDesc: "适合社交媒体的生活方式图",
    productDisplayImage: "商品展示图",
    productDisplayImageDesc: "纯净背景的商品大片",
    ugcVideo: "UGC 短视频",
    ugcVideoDesc: "生动的产品展示视频",
    taskPending: "等待中",
    taskProcessing: "生成中",
    taskCompleted: "已完成",
    taskFailed: "生成失败",
    ...
    // 错误信息
    errorNoData: "未找到分析数据，请返回重试",
    errorAnalysisFailed: "分析失败，请稍后重试",
    errorGenerationFailed: "生成失败，请稍后重试",
  },
