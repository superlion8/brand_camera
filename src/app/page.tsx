        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="p-8 rounded-2xl bg-zinc-50 border border-zinc-200">
              ...
              <p className="mt-3 text-sm text-zinc-500">Perfect for trying out</p>
              <ul className="mt-6 space-y-3">
                {['10 credits/month', 'Basic AI models', 'Standard quality', 'Email support'].map((item) => (
              ...
              <Link href="/login" className="mt-8 block w-full py-3 text-center bg-white border border-zinc-300 rounded-full font-medium text-zinc-700 hover:bg-zinc-50 transition-colors">
                Get Started
              </Link>
            </div>
            
            {/* Pro Plan */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2" />
              <span className="inline-block px-3 py-1 bg-white/20 rounded-full text-xs font-medium mb-4">Popular</span>
              <h3 className="text-lg font-semibold">Pro</h3>
              <div className="mt-4 flex items-baseline gap-1">
                <span className="text-4xl font-bold">$29</span>
                <span className="text-white/70">/month</span>
              </div>
              <p className="mt-3 text-sm text-white/80">For growing businesses</p>
              <ul className="mt-6 space-y-3">
                {['500 credits/month', 'All AI models', 'HD quality', 'Priority support', 'Custom models'].map((item) => (
              ...
              <Link href="/login" className="mt-8 block w-full py-3 text-center bg-white rounded-full font-medium text-orange-600 hover:bg-white/90 transition-colors shadow-lg">
                Start Free Trial
              </Link>
            </div>
          </motion.div>
